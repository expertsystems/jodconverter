...
public class DefaultDocumentFormatRegistry extends SimpleDocumentFormatRegistry {
  	...
  	public DefaultDocumentFormatRegistry() {
        ...
        DocumentFormat gif = new DocumentFormat("Graphics Interchange Format", "gif", "image/gif");
        gif.setInputFamily(DocumentFamily.DRAWING);
        addFormat(gif);

        DocumentFormat jpg = new DocumentFormat("Joint Photographic Exchange Group", "jpg", "image/jpeg");
        jpg.setInputFamily(DocumentFamily.DRAWING);
        addFormat(jpg);

        DocumentFormat png = new DocumentFormat("Portable Network Graphics", "png", "image/png");
        png.setInputFamily(DocumentFamily.DRAWING);
        addFormat(png);
